...
public class EmployeeServiceImpl implements IEmployeeService {
    ...
    /**
     * Fetches all employees from the repository and maps them to EmployeeDto objects.
     *
     * This method retrieves a list of all Employee entities from the employee repository
     * and maps each Employee entity to its corresponding EmployeeDto. The resulting list of EmployeeDto
     * objects is then returned.
     *
     * @return List<EmployeeDto> A list of EmployeeDto objects representing all employees.
     */
    @Override
